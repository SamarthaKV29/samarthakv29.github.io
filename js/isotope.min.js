            ...
            filterFindElements: function(t, o) {
                ...
                return (t = i.makeArray(t)).forEach(function(t) {
                    if (t instanceof HTMLElement)
                        if (o) { e(t, o) && n.push(t); for (var i = t.querySelectorAll(o), s = 0; s < i.length; s++) n.push(i[s]) } else n.push(t)
                }), n
            },
    ...
    var l = function() {
        return function(t) {
            ...
            var e = u(t).split(" "),
                i = e[0],
                o = i.match(/^\[(.+)\]$/),
                n = (r = o && o[1], a = i, r ? function(t) { return t.getAttribute(r) } : function(t) { var e = t.querySelector(a); return e && e.textContent }),
