! function(e) {
    ...
    e.fn.attr2 = function() { if (!r) return this.attr.apply(this, arguments); var e = this.prop.apply(this, arguments); return e && e.jquery || "string" == typeof e ? e : this.attr.apply(this, arguments) }, e.fn.ajaxSubmit = function(a) {
        if (!this.length) return i("ajaxSubmit: skipping submit process - no element selected"), this;
        var n, o, s, u = this;
        "function" == typeof a && (a = { success: a }), n = this.attr2("method"), (s = (s = "string" == typeof(o = this.attr2("action")) ? e.trim(o) : "") || window.location.href || "") && (s = (s.match(/^([^#]+)/) || [])[1]), a = e.extend(!0, { url: s, success: e.ajaxSettings.success, type: n || "GET", iframeSrc: /^https/i.test(window.location.href || "") ? "javascript:false" : "about:blank" }, a);
        var l = {};
        ...
        var h = [];
        if (a.resetForm && h.push(function() { u.resetForm() }), a.clearForm && h.push(function() { u.clearForm(a.includeHidden) }), !a.dataType && a.target) {
        ...
        a.success = function(e, t, r) { for (var n = a.context || this, i = 0, o = h.length; i < o; i++) h[i].apply(n, [e, t, r || u, u]) };
        ...
        i("fileAPI :" + y);
        var T, j = (g || b) && !y;
        !1 !== a.iframe && (a.iframe || j) ? a.closeKeepAlive ? e.get(a.closeKeepAlive, function() { T = S(d) }) : T = S(d) : T = (g || b) && y ? function(t) {
            ...
            s.data = null;
            var u = s.beforeSend;
            return s.beforeSend = function(e, t) { t.data = r, u && u.call(this, e, t) }, e.ajax(s)
        ...
        function S(t) {
            ...
            if ((l = e.extend(!0, {}, e.ajaxSettings, a)).context = l.context || l, f = "jqFormIO" + (new Date).getTime(), l.iframeTarget ? (g = (d = e(l.iframeTarget)).attr2("name")) ? f = g : d.attr2("name", f) : (d = e('<iframe name="' + f + '" src="' + l.iframeSrc + '" />')).css({ position: "absolute", top: "-1000px", left: "-1000px" }), p = d[0], h = {
                    aborted: 0,
                    responseText: null,
                    responseXML: null,
                    status: 0,
                    ...
                    abort: function(t) {
                        ...
                        try { p.contentWindow.document.execCommand && p.contentWindow.document.execCommand("Stop") } catch (e) {}
            ...
            function S(e) { var t = null; try { e.contentWindow && (t = e.contentWindow.document) } catch (e) { i("cannot get iframe.contentWindow document: " + e) } if (t) return t; try { t = e.contentDocument ? e.contentDocument : e.document } catch (r) { i("cannot get iframe.contentDocument: " + r), t = e.document } return t }
            ...
            function A() {
                var t = u.attr2("target"),
                    r = u.attr2("action");
                y.setAttribute("target", f), n || y.setAttribute("method", "POST"), r != l.url && y.setAttribute("action", l.url), l.skipEncodingOverride || n && !/post/i.test(n) || u.attr({ encoding: "multipart/form-data", enctype: "multipart/form-data" }), l.timeout && (b = setTimeout(function() { x = !0, O(j) }, l.timeout));
                var a = [];
                try {
                    if (l.extraData)
                    ...
                    l.iframeTarget || (d.appendTo("body"), p.attachEvent ? p.attachEvent("onload", O) : p.addEventListener("load", O, !1)), setTimeout(function e() {
                        ...
                        } catch (e) { i("Server abort: ", e, " (", e.name, ")"), O(w), b && clearTimeout(b), b = void 0 }
                    }, 15);
                    try { y.submit() } catch (e) { document.createElement("form").submit.apply(y) }
                } finally { y.setAttribute("action", r), t ? y.setAttribute("target", t) : u.removeAttr("target"), e(a).remove() }
            }
                ...
                if (!h.aborted && !M) {
                    ...
                    if (L && L.location.href != l.iframeSrc || x) {
                        ...
                        try {
                            ...
                            h.responseText = o ? o.innerHTML : null, h.responseXML = L.XMLDocument ? L.XMLDocument : L, n && (l.dataType = "xml"), h.getResponseHeader = function(e) { return { "content-type": l.dataType }[e] }, o && (h.status = Number(o.getAttribute("status")) || h.status, h.statusText = o.getAttribute("statusText") || h.statusText);
    ...
    }, e.fn.ajaxForm = function(t) { if ((t = t || {}).delegation = t.delegation && e.isFunction(e.fn.on), !t.delegation && 0 === this.length) { var r = { s: this.selector, c: this.context }; return !e.isReady && r.s ? (i("DOM not ready, queuing ajaxForm"), e(function() { e(r.s, r.c).ajaxForm(t) }), this) : (i("terminating; zero elements found by selector" + (e.isReady ? "" : " (DOM not ready)")), this) } return t.delegation ? (e(document).off("submit.form-plugin", this.selector, a).off("click.form-plugin", this.selector, n).on("submit.form-plugin", this.selector, t, a).on("click.form-plugin", this.selector, t, n), this) : this.ajaxFormUnbind().bind("submit.form-plugin", t, a).bind("click.form-plugin", t, n) }, e.fn.ajaxFormUnbind = function() { return this.unbind("submit.form-plugin click.form-plugin") }, e.fn.formToArray = function(r, a) {
        var n = [];
        ...
        for (i = 0, c = d.length; i < c; i++)
            if ((s = (l = d[i]).name) && !l.disabled)
                if (r && m.clk && "image" == l.type) m.clk == l && (n.push({ name: s, value: e(l).val(), type: l.type }), n.push({ name: s + ".x", value: m.clk_x }, { name: s + ".y", value: m.clk_y }));
                else if ((u = e.fieldValue(l, !0)) && u.constructor == Array)
            for (a && a.push(l), o = 0, f = u.length; o < f; o++) n.push({ name: s, value: u[o] });
        else if (t.fileapi && "file" == l.type) {
            a && a.push(l);
            var p = l.files;
            if (p.length)
                for (o = 0; o < p.length; o++) n.push({ name: s, value: p[o], type: l.type });
            else n.push({ name: s, value: "", type: l.type })
        } else null !== u && void 0 !== u && (a && a.push(l), n.push({ name: s, value: u, type: l.type, required: l.required }));
        if (!r && m.clk) {
            var h = e(m.clk),
                v = h[0];
            (s = v.name) && !v.disabled && "image" == v.type && (n.push({ name: s, value: h.val() }), n.push({ name: s + ".x", value: m.clk_x }, { name: s + ".y", value: m.clk_y }))
        }
        return n
